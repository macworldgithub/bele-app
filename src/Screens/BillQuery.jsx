    ...
    <KeyboardAvoidingView behavior="padding" style={tw`flex-1`}>
      ...
      >
        ...
        <View style={tw`bg-white rounded-xl shadow p-4 mb-6 border border-gray-300`}>
          <Text style={tw`text-base font-semibold mb-3`}>Current Bill - {user.bill.month}</Text>
        ...
        <View style={tw`bg-white rounded-xl shadow p-4 mb-6 border border-gray-200`}>
          <Text style={tw`text-base font-semibold mb-2`}>Ask About Your Bill</Text>
          <Text style={tw`text-xs text-gray-500 mb-3`}>
            Describe your billing question or concern, e.g., "Why was my bill high?" or "International calls"
          </Text>
          ...
          <Text style={tw`text-xs text-gray-500 mb-2`}>Common Issues We Can Help With:</Text>
          <View style={tw`pl-2`}>
            {[
