...
//           <Text style={tw`text-xs text-gray-600 mb-2`}>• Enter specific addresses for more accurate results.</Text>
//           <Text style={tw`text-xs text-gray-600 mb-2`}>• Coverage may vary inside buildings or underground.</Text>
//           <Text style={tw`text-xs text-gray-600 mb-2`}>• 5G coverage is expanding to more areas monthly.</Text>
//           <Text style={tw`text-xs text-gray-600`}>• Contact support for coverage improvement requests.</Text>
//         </View>
//       </ScrollView>
    ...
    <KeyboardAvoidingView behavior="padding" style={tw`flex-1`}>
      ...
      >
        ...
        <View style={tw`bg-white rounded-xl p-4 border border-gray-200`}>
          ...
          <Text style={tw`text-xs text-gray-500 mb-4`}>
            Enter a ZIP code or address, e.g., "12345" or "Castle Hill"
          </Text>

          {/* Only one input for ZIP/Address */}
          <TextInput
            style={tw`border border-gray-300 rounded-lg px-3 py-2 mb-3`}
            placeholder="ZIP code (e.g., 12345) or full address"
            placeholderTextColor="#9CA3AF"
